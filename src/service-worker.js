...
registerRoute(
  ...
  ({ url }) =>
    url.origin === self.location.origin && url.pathname.indexOf("/images") > -1, // Customize this strategy as needed, e.g., by changing to CacheFirst.
...
self.addEventListener("push", function (e) {
  ...
  e.waitUntil(
    ...
    self.registration.showNotification("Saxo Trader", notificationOptions)
  );
});
